...
# app.config['SQLALCHEMY_DATABASE_URI'] = "mysql://root:@localhost/ecom"  # Replace with your actual database credentials
...
def signup():
    if request.method == 'POST':
        ...
        return render_template('index.html', trending_products=trending_products.head(8), 
                               truncate=truncate, random_product_image_urls=random_product_image_urls,
                               random_price=random.choice(price), signup_message='User signed up successfully!')
...
def signin():
    if request.method == 'POST':
        ...
        return render_template('index.html', trending_products=trending_products.head(8), 
                               truncate=truncate, random_product_image_urls=random_product_image_urls,
                               random_price=random.choice(price), signin_message='User signed in successfully!')
